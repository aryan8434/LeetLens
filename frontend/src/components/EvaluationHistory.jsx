                  ...
                  >
                    ...
                    <div className="profile-history-actions">
                      <button
                        ...
                        onClick={() => onReuseSearch?.(search.username)}
                      >
                        Reuse Search
                      </button>
                      {search.savedReport ? (
                        <button
                          type="button"
                          className="profile-history-btn profile-history-btn-secondary"
                          onClick={() => onOpenReport?.(search.savedReport)}
                        >
                          Open Saved Evaluation
                        </button>
                      ) : (
                        <span className="profile-history-empty-note">
